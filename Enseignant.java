...
import static model.DBRecherche.getstring;

/**
 * classe controle l'interface pour les enseignant
 */
    ...
    public void paint(final int droit)
    {
        ...
        recap.addActionListener(new ActionListener ()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                contenu.add(r);//on ajout r au container
                r.setBounds(10,140,1800,760);//on set les coordonées de r
                //on remet les element graphique de 'interface
                contenu.add(edt);
                contenu.add(recap);
                contenu.add(perso);
